 ...
 */
public class ChatEdgeRenderer extends AbstractShapeRenderer {
     ...
     */
    public ChatEdgeRenderer(String textField) {
     ...
     * drawn.
     */
    public ChatEdgeRenderer(String textField, String imageField) {
